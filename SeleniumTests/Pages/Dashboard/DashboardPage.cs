...
namespace SeleniumTests.Pages.Dashboard
{
    public class DashboardPage
    {
        ...
        [FindsBy(How = How.CssSelector, Using = "#kt_Dashboard_password_reset_form > div.fv-row.mb-10 > input")]
        private IWebElement EmailField;

        [FindsBy(How = How.Id, Using = "kt_sign_in_submit")]
        private IWebElement DashboardButton;

        [FindsBy(How = How.XPath, Using = "//app-Dashboard//form//a[contains(text(),'Forgot Password')]")]
        ...
        public bool IsDashboardButtonEnabled()
        {
            return DashboardButton.Enabled;
        }
        ...
        public bool IsDashboardSuccessful()
        {
            // Add logic to verify Dashboard, such as checking if a specific element is visible after Dashboard
