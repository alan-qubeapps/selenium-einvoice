...
namespace SeleniumTests.Tests.L_Functional.L.Dashboard
{

    public static class ExcelDataReaderDashboardValid
    {
    ...
    public class LoginTest
    {
        ...
        ExcelDataReaderDashboardValid.GetForgotPasswordTestData(ExcelPath, "ForgotPasswordTestData");
