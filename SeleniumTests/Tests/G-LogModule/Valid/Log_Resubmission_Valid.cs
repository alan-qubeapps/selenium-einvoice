...
namespace SeleniumTests.Tests.G_Log
{
    ...
    public static class ExcelDataReaderLogResubmissionValid
    {
    ...
    [AllureEpic("ERP-117")]
    public class Log_Resubmission_Valid
    {
        ...
        private static string ExcelPath = Path.Combine(AppConfig.TestDataFolder, "LogResubmissionTestDataValid.xlsx");

        public static IEnumerable<object[]> SearchLogTestData =>
        ExcelDataReaderLogExportedValid.GetSearchLogTestData(ExcelPath, "SearchLogTestData");

        public static IEnumerable<object[]> ResetLogTestData =>
        ExcelDataReaderLogExportedValid.GetResetLogTestData(ExcelPath, "ResetLogTestData");

        public static IEnumerable<object[]> FilterUserLogTestData =>
        ExcelDataReaderLogExportedValid.GetFilterUserLogTestData(ExcelPath, "FilterUserLogTestData");
        ...
        public void OneTimeSetUp()
        {
            ...
            string moduleName = "Log Resubmission Page"; // You can make this dynamic if needed
        ...
        public void SetUp()
        {
            ...
            _moduleName = "Log Resubmission Page";
        ...
        public void Search_Resubmission_Log(string searchText, int columnIndex)
        {
            try
            {
                // Navigate to Resubmission Logs Tab
                var ResubmissionTab = _wait.Until(ExpectedConditions.ElementToBeClickable(
                By.XPath("//a[contains(@class,'nav-link') and contains(normalize-space(text()),'Resubmission')]")
                ));
                ResubmissionTab.Click();
                WaitForUIEffect();
                LogStep("✅ Switched to Resubmission Logs tab");
        ...
        public void ExportLogResubmissionReport()
        {
            ...
            WaitForUIEffect();
            LogStep("📤 Clicked export button on Resubmission tab");
            ...
            try
            {
                ...
                if (modal != null)
                {
                    ...
                    _lastScreenshotPath = Path.Combine(Path.GetTempPath(), $"Log_Resubmission_{DateTime.Now:yyyyMMdd_HHmmss}.png");
                    var screenshot = ((ITakesScreenshot)_driver).GetScreenshot();
                    File.WriteAllBytes(_lastScreenshotPath, screenshot.AsByteArray);
        ...
        public void Reset_After_Search_Resubmission_Log(string searchText, int columnIndex)
        {
            try
            {
        ...
        public void Filter_User_Resubmission_Log(string searchText, int columnIndex)
        {
            try
            {
                var logResubmissionTab = _wait.Until(ExpectedConditions.ElementToBeClickable(
