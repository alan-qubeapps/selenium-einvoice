...
namespace SeleniumTests.Tests.G_Log
{
    ...
    public static class ExcelDataReaderLogLogoutAllValid
    {
    ...
    [AllureEpic("ERP-117")]
    public class Log_LogoutAll_Valid
    {
        ...
        private static string ExcelPath = Path.Combine(AppConfig.TestDataFolder, "LogLogoutAllTestDataValid.xlsx");
        ...
        public void OneTimeSetUp()
        {
            ...
            string moduleName = "Log Logout All Page"; // You can make this dynamic if needed
        ...
        public void SetUp()
        {
            ...
            _moduleName = "Log Logout All Page";
