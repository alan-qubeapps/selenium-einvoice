...
namespace SeleniumTests.Tests.G_Log
{
    ...
    public static class ExcelDataReaderLogExportedValid
    {
    ...
    [AllureEpic("ERP-117")]
    public class Log_Exported_Valid
    {
        ...
        private static string ExcelPath = Path.Combine(AppConfig.TestDataFolder, "LogExportedTestDataValid.xlsx");
        ...
        public void OneTimeSetUp()
        {
            ...
            string moduleName = "Log Exported Page"; // You can make this dynamic if needed
        ...
        public void Search_Exported_Log(string searchText, int columnIndex)
        {
            try
            {
                // Navigate to Exported Logs Tab
                ...
                WaitForUIEffect();
                LogStep("✅ Switched to Exported Logs tab");
        ...
        public void ExportLogExportedReport()
        {
            ...
            WaitForUIEffect();
            LogStep("📤 Clicked export button on Log Exported tab");
            ...
            try
            {
                ...
                if (modal != null)
                {
                    ...
                    if (!message.ToLower().Contains("under processing due to large size"))
                    {
                        ...
                        _lastScreenshotPath = Path.Combine(Path.GetTempPath(), $"Log_Exported_{DateTime.Now:yyyyMMdd_HHmmss}.png");
                        var screenshot = ((ITakesScreenshot)_driver).GetScreenshot();
                        File.WriteAllBytes(_lastScreenshotPath, screenshot.AsByteArray);
                    }
        ...
        public void Reset_After_Search_Exported_Log(string searchText, int columnIndex)
        {
            try
            {
                var logExportedTab = _wait.Until(ExpectedConditions.ElementToBeClickable(
        ...
        public void Filter_User_Exported_Log(string searchText, int columnIndex)
        {
            try
            {
                var logExportedTab = _wait.Until(ExpectedConditions.ElementToBeClickable(
