...
namespace SeleniumTests.Tests.G_Log
{
    ...
    public static class ExcelDataReaderLogCreatedValid
    {
    ...
    [AllureEpic("ERP-117")]
    public class Log_Created_Valid
    {
        ...
        private static string ExcelPath = Path.Combine(AppConfig.TestDataFolder, "LogCreatedTestDataValid.xlsx");

        public static IEnumerable<object[]> SearchLogTestData =>
        ExcelDataReaderLogCreatedValid.GetSearchLogTestData(ExcelPath, "SearchLogTestData");

        public static IEnumerable<object[]> ResetLogTestData =>
        ExcelDataReaderLogCreatedValid.GetResetLogTestData(ExcelPath, "ResetLogTestData");

        public static IEnumerable<object[]> FilterUserLogTestData =>
        ExcelDataReaderLogCreatedValid.GetFilterUserLogTestData(ExcelPath, "FilterUserLogTestData");
        ...
        public void OneTimeSetUp()
        {
            ...
            string moduleName = "Log Created Page"; // You can make this dynamic if needed
        ...
        public void Search_Created_Log(string searchText, int columnIndex)
        {
            try
            {
                // Navigate to Created Logs Tab
                var logCreatedTab = _driver.FindElement(
        ...
        [Test]
        [Category("Log Created")]
        [Order(2)]
        [AllureSeverity(SeverityLevel.normal)]
        [AllureStory("Create - Export Log Report")]
        public void ExportLogCreatedReport()
        {
            ...
            WaitForUIEffect();
            LogStep("📤 Clicked export button on Log Created tab");
            ...
            try
            {
                ...
                if (modal != null)
                {
                    ...
                    LogStep("Export is being processed in background. Skipping file download check.");
                }
        ...
        public void Reset_After_Search_Created_Log(string searchText, int columnIndex)
        {
            try
            {
                var logCreatedTab = _driver.FindElement(
        ...
        public void Filter_User_Created_Log(string searchText, int columnIndex)
        {
            try
            {
                var logCreatedTab = _driver.FindElement(
