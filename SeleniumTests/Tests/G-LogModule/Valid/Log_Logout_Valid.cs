...
namespace SeleniumTests.Tests.G_Log
{
    ...
    public static class ExcelDataReaderLogLogoutValid
    {
    ...
    public class Log_Logout_Valid
    {
        ...
        private static string ExcelPath = Path.Combine(AppConfig.TestDataFolder, "LogLogoutTestDataValid.xlsx");
        ...
        public void OneTimeSetUp()
        {
            ...
            string moduleName = "Log Logout Page"; // You can make this dynamic if needed
