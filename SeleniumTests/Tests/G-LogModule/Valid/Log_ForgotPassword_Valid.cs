...
namespace SeleniumTests.Tests.G_Log
{
    ...
    public static class ExcelDataReaderLogForgotPasswordValid
    {
    ...
    public class Log_ForgotPassword_Valid
    {
        ...
        private static string ExcelPath = Path.Combine(AppConfig.TestDataFolder, "LogForgotPasswordTestDataValid.xlsx");

        public static IEnumerable<object[]> SearchLogTestData =>
        ExcelDataReaderLogForgotPasswordValid.GetSearchLogTestData(ExcelPath, "SearchLogTestData");

        public static IEnumerable<object[]> ResetLogTestData =>
        ExcelDataReaderLogForgotPasswordValid.GetResetLogTestData(ExcelPath, "ResetLogTestData");

        public static IEnumerable<object[]> FilterUserLogTestData =>
        ExcelDataReaderLogForgotPasswordValid.GetFilterUserLogTestData(ExcelPath, "FilterUserLogTestData");
        ...
        public void Search_ForgotPassword_Log(string searchText, int columnIndex)
        {
            try
            {
        ...
        public void Reset_After_Search_ForgotPassword_Log(string searchText, int columnIndex)
        {
            try
            {
                //  Navigate to 'Forgot Password' tab
        ...
        public void Filter_User_ForgotPassword_Log(string searchText, int columnIndex)
        {
            try
            {
                //  Navigate to 'Forgot Password' tab
