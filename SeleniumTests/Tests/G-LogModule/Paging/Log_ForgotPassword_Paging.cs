...
namespace SeleniumTests.Tests.G_Log.Paging
{
    ...
    public class Log_ForgotPassword_Paging
    {
        ...
        public void OneTimeSetUp()
        {
            ...
            string moduleName = "Log Forgot Password Page - Paging"; // You can make this dynamic if needed
        ...
        public void SetUp()
        {
            ...
            _moduleName = "Log Forgot Password Page - Paging";
        ...
        public void Log_ForgotPassword_TestPagingNextButtonAndVerify()
        {
            try
            {
                LogStep("Switching to 'Forgot Password' tab");
                var LogForgotPasswordTab = _wait.Until(ExpectedConditions.ElementToBeClickable(
                    By.XPath("/html/body/app-layout/div/div/div/div/app-content/app-log-details/div/div[1]/div/ul/li[5]/a")));
                LogForgotPasswordTab.Click();
                WaitForUIEffect();
                ...
                if (isDisabled)
                {
                    LogStep("⚠️ 'Next' button is disabled — only one page exists.");
                    _lastScreenshotPath = Path.Combine(Path.GetTempPath(), $"Log_ForgotPassword_Page_{DateTime.Now:yyyyMMdd_HHmmss}.png");
        ...
        public void Log_ForgotPassword_TestPagingPreviousButtonAndVerify()
        {
            try
            {
                LogStep("Switching to 'Forgot Password' tab");
                ...
                try
                {
                    ...
                    {
                        LogStep("ℹ️ Table did not change after clicking 'Next' (may already be on last page)");
                    }
                }
                catch (Exception e)
                {
                    LogStep($"⚠️ Exception while clicking 'Next': {e.Message}");
                }
                ...
                try
                {
                    ...
                    {
                        LogStep("ℹ️ Table did not return to original — possibly not on page 1 initially");
                    }
                }
                catch (Exception e)
                {
                    LogStep($"⚠️ Exception while clicking 'Previous': {e.Message}");
                }
        ...
        public void Log_ForgotPassword_TestPagingClickLastIconAndVerify()
        {
            try
            {
                LogStep("Switching to 'Forgot Password' tab");
        ...
        public void Log_ForgotPassword_TestPagingFirstButtonAndVerify()
        {
            string tableXPath = "//table/tbody/tr[1]";

            try
            {
                LogStep("🧭 Navigating to 'Forgot Password' tab");
                var logForgotPasswordTab = _wait.Until(ExpectedConditions.ElementToBeClickable(
                    By.XPath("/html/body/app-layout/div/div/div/div/app-content/app-log-details/div/div[1]/div/ul/li[5]/a")));
                logForgotPasswordTab.Click();
                WaitForUIEffect();
        ...
        [TestCase("100")]
        public void Log_ForgotPassword_TestItemsPerPageVerify(string pageSizeValue)
        {
            LogStep("🧭 Navigating to 'Forgot Password' tab");
            var LogForgotPasswordTab = _wait.Until(ExpectedConditions.ElementToBeClickable(
            By.XPath("/html/body/app-layout/div/div/div/div/app-content/app-log-details/div/div[1]/div/ul/li[5]/a")
            ...
            LogStep("Selecting dropdown value: " + pageSizeValue);
            ...
            LogStep("✅ Table updated after selecting new page size");
        }
        ...
        [TestCase("3")]
        public void Log_ForgotPassword_TestClickPageButtonIfExists(string pageNumber)
        {
            LogStep("🧭 Navigating to 'Forgot Password' tab");
            var LogForgotPasswordTab = _wait.Until(ExpectedConditions.ElementToBeClickable(
            By.XPath("/html/body/app-layout/div/div/div/div/app-content/app-log-details/div/div[1]/div/ul/li[5]/a")
            ...
            LogStep("🔍 Capturing current table HTML before pagination");
            var tableElement = _wait.Until(ExpectedConditions.ElementIsVisible(By.XPath(tableXPath)));
            string beforeHtml = tableElement.GetAttribute("innerHTML");
            ...
            {
                LogStep($"ℹ️ Page {pageNumber} button not available. Likely only one page.");
                Assert.IsTrue(true); // Graceful pass
                return;
            }
            ...
            LogStep("⏳ Waiting for table to update after clicking page button");
            bool tableUpdated = _wait.Until(driver =>
            {
                var updatedTable = driver.FindElement(By.XPath(tableXPath));
                string afterHtml = updatedTable.GetAttribute("innerHTML");
