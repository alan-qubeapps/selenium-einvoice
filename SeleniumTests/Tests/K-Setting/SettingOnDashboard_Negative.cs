...
namespace SeleniumTests.Tests.K_Setting
{
    ...
    public static class ExcelDataReaderSettingOnDashboardNegative
    {
    ...
    [AllureEpic("ERP-117")]
    public class SettingOnDashboard_Negative
    {
        ...
        private static string ExcelPath = Path.Combine(AppConfig.TestDataFolder, "SettingOnDashboardTestDataNegative.xlsx");

        // Data source for Create test
        public static IEnumerable<object[]> InvalidFileTestData =>
            ExcelDataReaderSettingOnDashboardNegative.GetInvalidFileTestData(ExcelPath, "InvalidFile_Dashboard");

        // Data source for Reset test
        public static IEnumerable<object[]> WrongFileTypeTestData =>
            ExcelDataReaderSettingOnDashboardNegative.GetWrongFileTypeTestData(ExcelPath, "WrongFileType");
        ...
        public void OneTimeSetUp()
        {
            ...
            string moduleName = "Setting On Dashboard Page - Negative";
        ...
        public void SetUp()
        {
            ...
            _moduleName = "Setting On Dashboard Page - Negative";
        ...
        public void Create_New_Setting_Negative_InvalidFile_Dashboard(string CutOffDate, string ConsolidateCutOffDate, string securityToken, string filePath)
        {
            ...
            try
            {
                ...
                // Negative assertion: Consolidate < Convert or invalid file
                _lastScreenshotPath = Path.Combine(Path.GetTempPath(), $"Setting_{DateTime.Now:yyyyMMdd_HHmmss}.png");
                var screenshot = ((ITakesScreenshot)_driver).GetScreenshot();
                File.WriteAllBytes(_lastScreenshotPath, screenshot.AsByteArray);

                Assert.IsTrue(messageNormalized.Contains("required")
                              || messageNormalized.Contains("cannot be earlier")
                              || messageNormalized.Contains("invalid"),
