...
namespace SeleniumTests.Tests.L_Functional.Login
{
    ...
    public class LoginTestNegative
    {
        ...
        public void OneTimeSetUp()
        {
            ...
            string moduleName = "Login Page Negative"; // can be dynamic if needed
            ...
            // 🔹 Determine next Excel version number
            int version = 1;
            string baseFileName;
            string exportPath;
            do
        ...
        public void SetUp()
        {
            ...
            // 📁 Build recording file path (share same version as Excel)
            ...
            // 🟢 Use version number for easy linking between Excel & video
