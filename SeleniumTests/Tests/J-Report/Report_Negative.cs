...
//    public static class ExcelDataReaderReportNegative
//    {
...
//        private static string ExcelPath = Path.Combine(AppConfig.TestDataFolder, "ReportTestDataNegative.xlsx");

//        public static IEnumerable<object[]> ExportReportTestData =>
//        ExcelDataReaderReportNegative.GetExportReportTestData(ExcelPath, "ExportReportTestData");
...
//            string moduleName = "Report Page - Negative";
...
//            _moduleName = "Report Page - Negative";
...
//        [AllureStory("Create - Filter Report - Negative Case (Date Range > 1 Year)")]
//        [TestCaseSource(nameof(ExportReportTestData))]
//        public void FilterUserReport_InvalidDateRange(string ReportName, string Frommonth, string Fromyear, string fromDay,
...
//            // ----- From Date -----
//            LogStep($"Selecting invalid date range: From {Frommonth}/{Fromyear}/{fromDay} to {Tomonth}/{Toyear}/{toDay}");
...
//                By.XPath($"//ngb-datepicker-month//div/span[normalize-space()='{fromDay}']")));
//            fromDate.Click();
...
//                By.XPath($"//ngb-datepicker-month//div/span[normalize-space()='{toDay}']")));
//            toDate.Click();
//            LogStep($"To date selected: {toDay}");
//            WaitForUIEffect();

//            // Confirm date selection
//            var selectBtn = _wait.Until(ExpectedConditions.ElementToBeClickable(
//                By.XPath("//ngb-datepicker/button")));
//            selectBtn.Click();
//            LogStep("Clicked 'Select' button to apply date range");
//            WaitForUIEffect(1000);

//            // Wait for modal to appear
//            LogStep("Waiting for validation modal to appear...");
//            var modal = _wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/div/div[2]")));
//            string modalText = modal.Text.Trim();
//            WaitForUIEffect(1000);

//            LogStep($"Modal message displayed: {modalText}");
//            Assert.AreEqual("Please select date within 1 year range.", modalText,
//                "❌ Modal message mismatch. Expected validation message not shown.");

//            // Take screenshot for report evidence
//            _lastScreenshotPath = Path.Combine(Path.GetTempPath(), $"InvalidDateRange_{DateTime.Now:yyyyMMdd_HHmmss}.png");
...
//            okButton.Click();
//            LogStep("Clicked 'OK' button to close modal");



//            LogStep("✅ Negative test success: Date range > 1 year validation works correctly.");
//        }
